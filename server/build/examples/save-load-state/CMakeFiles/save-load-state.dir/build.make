...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o: /Users/johnjones/Developer/file-embedding-search/server/llama.cpp/examples/save-load-state/save-load-state.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Users/johnjones/Developer/file-embedding-search/server/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o"
	cd /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state && /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/save-load-state.dir/save-load-state.cpp.o -c /Users/johnjones/Developer/file-embedding-search/server/llama.cpp/examples/save-load-state/save-load-state.cpp
...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.i: cmake_force
	...
	cd /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state && /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Users/johnjones/Developer/file-embedding-search/server/llama.cpp/examples/save-load-state/save-load-state.cpp > CMakeFiles/save-load-state.dir/save-load-state.cpp.i
...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.s: cmake_force
	...
	cd /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state && /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Users/johnjones/Developer/file-embedding-search/server/llama.cpp/examples/save-load-state/save-load-state.cpp -o CMakeFiles/save-load-state.dir/save-load-state.cpp.s
...
bin/save-load-state: examples/save-load-state/CMakeFiles/save-load-state.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Users/johnjones/Developer/file-embedding-search/server/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/save-load-state"
	cd /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/save-load-state.dir/link.txt --verbose=$(VERBOSE)
...
examples/save-load-state/CMakeFiles/save-load-state.dir/clean:
	cd /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state && $(CMAKE_COMMAND) -P CMakeFiles/save-load-state.dir/cmake_clean.cmake
...
examples/save-load-state/CMakeFiles/save-load-state.dir/depend:
	cd /Users/johnjones/Developer/file-embedding-search/server/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /Users/johnjones/Developer/file-embedding-search/server/llama.cpp /Users/johnjones/Developer/file-embedding-search/server/llama.cpp/examples/save-load-state /Users/johnjones/Developer/file-embedding-search/server/build /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state /Users/johnjones/Developer/file-embedding-search/server/build/examples/save-load-state/CMakeFiles/save-load-state.dir/DependInfo.cmake --color=$(COLOR)
